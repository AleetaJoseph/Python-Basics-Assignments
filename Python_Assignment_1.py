#1. String Concatenation: Write a Python program that takes two strings i.e string 1 “Hello ”, string 2 get name as
#input from the user and concatenates them together. Display the concatenated string as the output.
# concatenate string 3 “, welcome to Python programming” to the existing string and display the output string.
